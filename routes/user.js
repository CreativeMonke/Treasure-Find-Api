...
router.put("/edit/:userId", Verify, VerifyRole, validateUpdate, (req, res) =>
  editUserById(req, res, ["role"])
);

router.put("/editAccount/:userId", Verify, validateUpdate, editUserById);
